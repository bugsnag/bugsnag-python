...
def crash(request):
    divide.delay(1, 0)
    return HttpResponse(
        'The attached celery process should have an error, '
        + 'check <a href="https://bugsnag.com">bugsnag</a> dashboard for '
        + 'errors'
    )
...
def notify(request):
    ...
    return HttpResponse(
        'The attached celery process has manually notified '
