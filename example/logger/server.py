...
# This file demonstrates how errors will be reported to bugsnag through your
# logger, even without any explicit reference to bugsnag in your python code.
...
def crash_callback():
    ...
    attached by the global callback function in bugsnag_logger, and crash the
    app.
    """
...
def handle_zero_div():
    ...
    print(
        ...
        'https://app.bugsnag.com to view notifications'
    )
...
if __name__ == '__main__':
    # First one will not report to Bugsnag because it is below
    # handler.setLevel()
