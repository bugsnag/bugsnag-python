Bugsnag Notifier for Python <img src="https://travis-ci.org/bugsnag/bugsnag-python.svg?branch=master" alt="build status" class="build-status">
=========================
...
We love pull requests. See the [contributing guidelines](https://github.com/bugsnag/bugsnag-python/blob/master/CONTRIBUTING.md) for details
